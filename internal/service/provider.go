...
func NewBankService(baseClient base.Client, guilinBankSDK sdk.GuilinBankSDK, spdBankSDK sdk.SPDBankSDK, pinganBankSDK sdk.PinganBankSDK,
	...
	businessPayrollDetailRepo repo.BankBusinessPayrollDetailRepo, oaClient oa.Client, paymentReceiptRepo repo.PaymentReceiptRepo, pdfToImageService PdfToImageService) BankService {
	return &bankService{baseClient, guilinBankSDK, spdBankSDK, pinganBankSDK,
		...
		businessPayrollDetailRepo, oaClient, paymentReceiptRepo, pdfToImageService}
}
