...
type MinShengTransactionResponse struct {
	RespTime   string                            `json:"resp_time"`
	Items      []MinShengTransactionResponseItem `json:"result_list"`
	RespDesc   string                            `json:"resp_desc"`
	RespStatus string                            `json:"resp_status"`
	ReqSeq     string                            `json:"req_seq"`
	TotalNum   string                            `json:"total_num"`
	RespDate   string                            `json:"resp_date"`
	RespCode   string                            `json:"resp_code"`
	ItemNum    string                            `json:"item_num"`
}
type MinShengTransactionResponseItem struct {
