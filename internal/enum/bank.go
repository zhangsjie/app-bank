...
const MinShengRequestUrl = "/api/cmbcRequest"
const MinShengAppId = "bankConfig.minsheng.appId"
const MinShengEnterpriseIdCode = "bankConfig.minsheng.enterpriseIdCode"
